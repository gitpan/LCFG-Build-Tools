package LCFG::Build::Tool::MajorVersion;    # -*-cperl-*-
use strict;
use warnings;
...
# $Revision: 3446 $
# $HeadURL: https://svn.lcfg.org/svn/source/tags/LCFG-Build-Tools/LCFG_Build_Tools_0_0_55/lib/LCFG/Build/Tool/MajorVersion.pm.in $
...
=head1 VERSION
    ...
    This documentation refers to LCFG::Build::Tool::MajorVersion version 0.0.55
